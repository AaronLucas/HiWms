...
- `.claude/rules/ecc/{common,typescript}/`：ECC 插件规则文本（项目本地路径，不提交入库）。已完成与本项目文档的冲突映射（`docs/06-agents/AGENTS.md` §8.3.1），交集处理结果（保留/替换/引用）已落地至 `docs/00-project/CONVENTIONS.md` §6-§13、`docs/04-workflows/WORKFLOWS.md` §3.1-3.2、`.github/workflows/ci.yml`（main/dev 双触发，硬门禁）
